...
This directory contains prompts and responses from Aletheia on research level
math problems.

Note that 2 outputs, one in
Erdos problems and one in LeeSeo26, are not from Aletheia. The latter is for
